...
Un **Aula Virtual** (también llamada **LMS** — *Learning Management System*) es un ecosistema digital diseñado para replicar y superar la experiencia del aula presencial. Va mucho más allá de ser un simple repositorio de archivos: es una plataforma integral que gestiona **todo el ciclo de vida del aprendizaje**.
...
*Convertir los "ramos" de Aulika en "cursos" con materiales*
...
*Expandir el sistema de evaluaciones existente*
...
*Documento generado por Antigravity AI — Investigación realizada: 2026-06-26*
*Actualizado: 2026-06-26 — Decisiones de arquitectura finales confirmadas en conversación*
*Próxima revisión sugerida: Al iniciar el diseño técnico del schema Prisma del Aula Virtual*
