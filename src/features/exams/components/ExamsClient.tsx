    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-foreground text-2xl font-bold">Exámenes</h1>
                    <p className="text-muted-foreground text-sm">{exams.length} exámenes creados</p>
                </div>
            ...
            {exams.length === 0 ? (
                <div className="border-border flex flex-col items-center justify-center rounded-2xl border border-dashed bg-white py-20">
                    ...
                    <p className="text-muted-foreground font-medium">Todavía no hay exámenes</p>
                    ...
                    {exams.map((exam) => (
                        ...
                        >
                            ...
                            <p className="text-muted-foreground mt-1.5 text-xs">
                                Nota máx {exam.maxGrade} · Aprobación {exam.passingGrade} (
            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
                <DialogContent className="flex max-h-[90vh] flex-col sm:max-w-lg">
                    ...
                    <div className="flex-1 space-y-4 overflow-y-auto py-2">
                        ...
                        {/* Groups multi-select */}
                        <div className="flex flex-col gap-1.5">
                            <p className="text-foreground text-sm font-medium">Grupos</p>
                            <div
                                className={cn(
                        ...
                        <div className="flex flex-col gap-2">
                            <p className="text-foreground text-sm font-medium">Escala de notas</p>
                            <div className="grid grid-cols-3 gap-2">
                                <div className="flex flex-col gap-1">
                                    <label
                                        htmlFor="exam-max-grade"
                                ...
                                <div className="flex flex-col gap-1">
                                    <label
                                        htmlFor="exam-passing-percentage"
                                        className="text-muted-foreground text-xs"
                                    >
                                        % mínimo
                                    </label>
                            ...
                            <p className="text-muted-foreground text-[11px]">
                                Con {form.passingPercentage}% de respuestas correctas se obtiene
                                nota {form.passingGrade} (máx {form.maxGrade}).
                            </p>
                        </div>
            ...
            <Dialog open={isDelOpen} onOpenChange={setIsDelOpen}>
                <DialogContent className="sm:max-w-sm">
                    ...
                    <p className="text-muted-foreground text-sm">
                        ...
                        <strong className="text-foreground">&ldquo;{toDelete?.title}&rdquo;</strong>
