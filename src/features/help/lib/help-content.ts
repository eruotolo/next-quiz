...
export const HELP_SECTIONS: HelpSection[] = [
    {
        ...
        steps: [
            'Revisá las tarjetas superiores para ver las métricas clave del momento.',
            'El bloque “Exámenes en curso” lista las evaluaciones activas en tiempo real.',
            'En “Últimos resultados” accedés rápido a las notas más recientes.',
        ],
    ...
    },
    {
        ...
        steps: [
            'Creá un grupo con el botón “Nuevo grupo”.',
            'Asigná uno o más profesores al grupo.',
            'Editá o eliminá grupos existentes cuando lo necesites.',
        ],
    ...
    },
    {
        ...
        steps: [
            'Agregá estudiantes de a uno con “Nuevo estudiante”.',
            'Importá listas completas desde un archivo Excel.',
            'Editá sus datos o activá/desactivá su acceso.',
        ],
        professorAccess: 'scoped',
        professorNote: 'Como profesor gestionás los estudiantes de tus grupos (ver, crear, editar). La eliminación queda reservada al administrador.',
        screenshots: {
    ...
    },
    {
        ...
        steps: [
            'Creá profesores con sus datos de acceso (email y contraseña).',
            'Editá o eliminá profesores existentes.',
            'Asignalos a los grupos desde la sección Grupos.',
        ],
        professorAccess: 'readonly',
        professorNote: 'Como profesor podés ver el listado del cuerpo docente, pero la gestión la realiza el administrador.',
    ...
    },
    {
        ...
        steps: [
            'Creá un examen con “Nuevo examen” y completá materia, unidad y fechas de inicio/cierre.',
            'Cargá las preguntas manualmente o importalas desde una plantilla.',
            'Configurá la vigilancia (anti-trampa) y la escala de evaluación.',
            'Publicá el examen para que los alumnos del grupo puedan rendirlo.',
        ],
        professorAccess: 'scoped',
        professorNote: 'Como profesor creás y editás exámenes para tus grupos. Al editar uno compartido, los grupos ajenos ya asignados se conservan.',
    ...
    },
    {
        ...
        steps: [
            'Filtrá por examen o por grupo.',
            'Abrí el detalle de un resultado para ver la respuesta de cada pregunta.',
            'Exportá o imprimí el comprobante cuando lo necesites.',
        ],
        professorAccess: 'scoped',
    ...
    },
    {
        ...
        steps: [
            'Elegí el examen activo que querés monitorear.',
            'Observá el avance pregunta por pregunta de cada estudiante a medida que responden.',
        ],
        professorAccess: 'scoped',
        professorNote: 'Como profesor monitoreás en vivo los exámenes de tus grupos.',
