...
import { OrderStatusPoller } from '../../../../checkout/[courseId]/exito/OrderStatusPoller';
...
export default async function CategoryCheckoutSuccessPage({ params, searchParams }: PageProps) {
