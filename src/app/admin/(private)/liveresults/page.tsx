...
import {
    ...
    type LiveExamData,
    type LiveResultRow,
} from './_components/LiveResultsClient';
...
export default async function LiveResultsPage({
    ...
    // Only accept a paramExamId if it's actually active
    const validParamId = activeExams.some((e) => e.id === paramExamId)
        ? paramExamId
        : undefined;
    ...
    if (examId) {
        ...
        if (exam) {
            ...
            // Group in-progress answers by student (skip already-completed students)
            ...
            // In-progress first (most answers first so most-advanced student is at top)
