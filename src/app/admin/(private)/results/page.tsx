...
import { ResultsClient, type ExamGroup, type ResultRow } from './_components/ResultsClient';
    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-sm text-muted-foreground">{results.length} entregas en total</p>
            </div>
