...
export default async function ExamPage({ params }: PageProps) {
    ...
    if (exam.oneAttempt) {
        ...
        if (existingResult) redirect(`/students/examen/resultado/${existingResult.id}`);
    }
    ...
    if (exam.uniqueIp) {
        ...
        if (clientIp) {
            ...
            if (ipConflict) redirect('/students/examen/login');
        }
    }
    ...
    if (!attempt?.endsAt) redirect(`/students/examen/${examId}/intro`);
